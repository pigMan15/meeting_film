...
@Slf4j
@Component
@Service(interfaceClass = AlipayAPI.class, mock = "com.stylefeng.guns.api.alipay.AlipayServiceMock")
...
//    private static Log log = LogFactory.getLog(Main.class);
    ...
    public String  test_trade_precreate(String orderId) {
        ...
        String operatorId = "pigMan";

        // (必填) 商户门店编号，通过门店号和商家后台可以配置精准到门店的折扣信息，详询支付宝技术支持
        String storeId = "pigMan";
...
//                dumpResponse(response);
                ...
                // 需要修改为运行机器上的路径
                 filePath = String.format("/Users/pigman2/Desktop/qr-%s.png",
